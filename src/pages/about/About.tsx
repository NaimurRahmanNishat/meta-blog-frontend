      ...
      <div className="container mx-auto max-w-7xl px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-20">
            ...
            <div className="order-2 md:order-1">
              <img
                src="https://images.unsplash.com/photo-1586928339731-7163f57d9469?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                alt=""
                className="w-full md:h-96 rounded-lg shadow-lg hover:scale-95 transition-all duration-200"
              />
            </div>
